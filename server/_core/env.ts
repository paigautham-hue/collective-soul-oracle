export const ENV = {
  ...
  deepResearchPreviewModel: process.env.DEEP_RESEARCH_PREVIEW_MODEL ?? "gemini-2.5-flash",
  deepResearchMaxModel: process.env.DEEP_RESEARCH_MAX_MODEL ?? "gemini-2.5-pro",
